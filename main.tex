...
%titlesec package for title spacing control
\begin{document}
...
\begin{itemize}
	...
	Having other objects vertically below the RO or between the persons head and shoulder in the picture puts the datapoint at risk of being discarded by the program due to its built-in data sanitisation.
...
\begin{itemize}
	\item The program should be paralellised as far as possible.
...
The author would like to extend his thanks to Sachin Govender (1036148) for his contribution, particularly to the Machine Learning layer of the system.
