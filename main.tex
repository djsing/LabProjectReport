...
Furthermore, the spread of error showed that about 61\% of participants had an error less than 10\%, and about 89\% of participants had an error less than 25\% with a mean absolute error of ***, and standard deviation of ***.}
\vspace{6pt}
]
